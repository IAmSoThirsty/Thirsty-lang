...
# Sign wheel
gpg --detach-sign --armor dist/thirsty_lang-0.8.3-py3-none-any.whl
# Creates: thirsty_lang-0.8.3-py3-none-any.whl.asc

# Upload both files to PyPI
twine upload dist/thirsty_lang-0.8.3* --sign --identity <YOUR_KEY_ID>
```
...
# Verify signature
gpg --verify thirsty_lang-0.8.3-py3-none-any.whl.asc thirsty_lang-0.8.3-py3-none-any.whl
```
